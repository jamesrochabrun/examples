...
//  ooApp
//
//  Created by Anuj Gujar on 8/20/15.
...
NSString *const kFontIconWhatsNewFilled = @"J";
NSString *const kFontIconPerson=  @"y";
NSString *const kFontIconCheckmarkCircle = @"n";
NSString *const kFontIconFavorite = @"Q";
NSString *const kFontIconFavoriteFilled = @"R";
NSString *const kFontIconDontCare = @"T";
NSString *const kFontIconPhoto = @"x";
NSString *const kFontIconUpload = @"F";
NSString *const kFontIconLocation = @"r";
NSString *const kFontIconLocationFilled = @"t";
NSString *const kFontIconToTry = @"o";
NSString *const kFontIconToTryFilled = @"A";
