...
- (void)updateLabelValues {
    ...
    self.minLabel.string = [_prices objectAtIndex:_selectedMinimum];// [formatter stringFromNumber:@(self.selectedMinimum)];
    self.maxLabel.string = [_prices objectAtIndex:_selectedMaximum];;//[formatter stringFromNumber:@(self.selectedMaximum)];
}
